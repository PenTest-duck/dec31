    ...
    <div className="min-h-screen bg-black">
      <header className="border-b border-zinc-800">
        <div className="max-w-2xl mx-auto px-4 h-12 flex items-center gap-3">
          <Link
            href="/dashboard"
            className="p-1.5 -ml-1.5 hover:bg-zinc-900 transition-colors"
          >
          ...
          <div className="space-y-4 pt-2">
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full h-9 px-3 border border-zinc-800 bg-zinc-900 text-sm text-white"
              >
                {TIMEZONES.map((tz) => (
            ...
            <div className="space-y-1.5">
              <Label htmlFor="time" className="text-xs text-zinc-400">Notification time</Label>
              <Input
                id="time"
                type="time"
                value={notificationTime}
                onChange={(e) => setNotificationTime(e.target.value)}
                className="w-full h-9 bg-zinc-900 border-zinc-800 text-white"
              />
              <p className="text-[10px] text-zinc-600">
                Daily email reminder at this time.
              </p>
            </div>
          </div>
        </section>
